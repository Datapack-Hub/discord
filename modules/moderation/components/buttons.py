...
class BanUserModPanelButton(discord.ui.Button):
    def __init__(self, user: discord.Member | None, cause_message: discord.Message | None = None, disabled: bool = False):
        self.user = user
...
class SoftBanUserModPanelButton(discord.ui.Button):
    def __init__(self, user: discord.Member | None, cause_message: discord.Message | None = None, disabled: bool = False):
        self.user = user
        self.cause_message = cause_message
